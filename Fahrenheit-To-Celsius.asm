...
fmt_error: .string "Usage: %s <fahrenheit>\n"   // Format string for error message

.data
thirtytwo: .double 32.0                         // The value 32.0 that we will use in the calculation in our formula for converting Fahrenheit to Celsius
...
main:
    ...
    fmov d8, 5.0                                // Load the value 5.0 into d8
    fmov d9, 9.0                                // Load the value 9.0 into d9
    ...
    fsub d11, d6, d10                           // Subtract 32.0 from the Fahrenheit value
    fdiv d12, d8, d9                            // Divide 5.0 by 9.0
    fmul d13, d11, d12                          // Multiply the result of the subtraction by the division
